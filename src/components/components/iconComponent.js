...
// Exporting Icon Component Which Is Functional Component As Default
export default function IconComponent({type, isFilled}) {
    // Conditional Rendering
    if (type === 'sun') {
        return (
            <svg className='todo-app__icon' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
    ...
    } else if (type === 'alphabetical-sort') {
        return (
            <svg className='todo-app__icon' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
