...
export default function TaskComponent({name}) {
    ...
    return(
        <div className='todo-app__task'>
            <button className='todo-app__task-check-btn' onClick={(itemToChange.isDone) ? handleClickOfCheckBtnWhileDone : handleClickOfCheckBtnWhileNotDone}>
                <IconComponent type={(itemToChange.isDone) ? 'checked-circle' : 'circle'}/>
            </button>
            <input type="text" defaultValue={name} className='todo-app__task-input' />
            <button className='todo-app__task-star-btn' onClick={(itemToChange.isImportant) ? handleClickOfCheckBtnWhileImportant : handleClickOfCheckBtnWhileNotImportant}>
                <IconComponent type={'star'} isFilled={(itemToChange.isImportant) ? true : false}/>
            </button>
            <button className='todo-app__task-delete-btn' onClick={() => dispatch(actions.removeTodo(name))}>
